import"./modulepreload-polyfill-B5Qt9EMX.js";import{f as r}from"./fetch-DBomrZ5j.js";const d=async()=>{console.log("Moikka, maailma"),console.log("Haetaan paikallisesta tiedostosta");const t=document.getElementById("diary");console.log(t);const o=await r("http://localhost:3000/api/auth/entries");if(o.error){console.log("Tapahtui virhe entries fetch haussa!!");return}console.log(o),t.innerHTML="",o.forEach(e=>{const n=document.createElement("div");n.classList.add("card");const s=document.createElement("div");s.classList.add("card-diary"),s.innerHTML=`
